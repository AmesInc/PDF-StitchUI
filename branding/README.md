...
This folder holds the committed branding reference material for `PDF-StitchUI`.

Contents:

- `brand-brief.md`: positioning, visual principles, and first-round concept prompts
